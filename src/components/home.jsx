...
function Home() {
  ...
  // Fetch currency names with .then()
  useEffect(()=>{
    fetch(apiUrl)
      .then((res) => res.json())
      .then((names) => {
  ...
  //  Fetch conversion rate with .then()
  useEffect(() => {
  ...
  return (
    <>
      <div className="container home-container1 mt-4">
        <p className="text-uppercase text-secondary fw-2 mt-3 mb-3">
            ...
            <div className="converter-card">
              <div className="row  align-items-center">
                  ...
                  <div className="mt-2 d-flex gap-2">
                    <Link
                      onClick={() => setFromCurrency("eur")}>
                        <button style={{border:"1px solid #ccc", borderRadius:"4px",height:"38px",width:"60px"}}> EUR</button>
                     
                    </Link>
                    <Link
                      >
                     <button style={{border:"1px solid #ccc", borderRadius:"4px",height:"38px",width:"60px"}} onClick={() => setFromCurrency("inr")}> INR</button>
                    </Link>
                    <Link
                      onClick={() => setFromCurrency("btc")}>
                     <button style={{border:"1px solid #ccc", borderRadius:"4px",height:"38px",width:"60px"}}> BTC</button>
                    </Link>
                    <Link
                      onClick={() => setFromCurrency("usd")}
                    >
                     <button style={{border:"1px solid #ccc", borderRadius:"4px",height:"38px",width:"60px"}}> USD</button>
                    </Link>
                  </div>
                </div>

                <div className="col-md-2 text-center">
                      <div className="exchange-arrow text-success"
                        style={{
                          marginTop: "10px",
                          fontSize: "25px",
                        }}
                ...
                <div className="col-md-5 " >
                  ...
                  <div className="mt-2 d-flex gap-2">
                    <Link
                      onClick={() => setToCurrency("eur")}>
                     <button style={{border:"1px solid #ccc", borderRadius:"4px",height:"38px",width:"60px"}}>EUR</button> 
                    </Link> 
                    <Link
                      onClick={() => setToCurrency("inr")}>
                     <button style={{border:"1px solid #ccc", borderRadius:"4px",height:"38px",width:"60px"}}> INR</button>
                    </Link>
                    <Link
          ...
          <div className="col-lg-4">
            <div className="chart-card">
              ...
              <p className="text-small-muted">
                EUR/USD for the 24-hour period ending Saturday, Aug 30, 2025
                23:59 UTC <br />
        ...
        <div className="row g-4">
            ...
            <div className="conversion-card">
              ...
              <table className="table rates table-borderless table-sm">
                <tbody>
                  ...
                  <tr>
                    <td>
                      <Link to="#">100 EUR</Link>
                    </td>
                    <td>116.840000 USD</td>
                  </tr>
                  <tr>
                    <td>
                      <Link to="#">500 EUR</Link>
                    </td>
                    <td>584.200000 USD</td>
                  </tr>
                  <tr>
                    <td>
                      <Link to="#">1,000 EUR</Link>
                    </td>
                    <td>1,168.400000 USD</td>
                  </tr>
                  <tr>
                    <td>
                      <Link to="#">5,000 EUR</Link>
                    </td>
                    <td>5,842.000000 USD</td>
                  </tr>
                  <tr>
                    <td>
                      <Link to="#">10,000 EUR</Link>
                    </td>
                    <td>11,684.000000 USD</td>
                  </tr>
                  <tr>
                    <td>
                      <Link to="#">50,000 EUR</Link>
                    </td>
                    <td>58,420.000000 USD</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="conversion-card">
              ...
              <table className="table rates table-borderless table-sm">
                <tbody>
                  ...
                  <tr>
                    <td>
                      <Link to="#">100 USD</Link>
                    </td>
                    <td>85.58713 EUR</td>
                  </tr>
                  <tr>
                    <td>
                      <Link to="#">500 USD</Link>
                    </td>
                    <td>427.9356 EUR</td>
                  </tr>
                  <tr>
                    <td>
                      <Link to="#">1,000 USD</Link>
                    </td>
                    <td>855.8713 EUR</td>
                  </tr>
                  <tr>
                    <td>
                      <Link to="#">5,000 USD</Link>
                    </td>
                    <td>4,279.356 EUR</td>
                  </tr>
                  <tr>
                    <td>
                      <Link to="#">10,000 USD</Link>
                    </td>
                    <td>8,558.713 EUR</td>
                  </tr>
                  <tr>
                    <td>
                      <Link to="#">50,000 USD</Link>
                    </td>
                    <td>42,793.56 EUR</td>
                  </tr>
                </tbody>
          ...
          <div className="col-lg-4">
            <div className="api-card">
              <h5>FX data API</h5>
              <p>
                Our API can be integrated into your ERP, giving you access to
                accurate, historical FX data and rates.
              </p>
          ...
          <div className="col-md-4">
            <div className="card p-3">
              ...
              <p className="mt-3">
                ...
                member countries. The following countries have adopted the euro:
        ...
        <div className="row row-cols-1 row-cols-md-3 g-4">
          <div className="col">
            <ul className="list-unstyled">
              <li>
                <img src="https://flagcdn.com/w20/ae.png" alt="AED" />{" "}
                <strong>AED</strong> <Link to="#">Utd. Arab Emir. Dirham</Link>
              </li>
              <li>
                <img src="https://flagcdn.com/w20/ch.png" alt="CHF" />{" "}
                <strong>CHF</strong> <Link to="#">Swiss Franc</Link>
              </li>
              <li>
                <img src="https://flagcdn.com/w20/gb.png" alt="GBP" />{" "}
                <strong>GBP</strong> <Link to="#">British Pound</Link>
              </li>
              <li>
                <img src="https://flagcdn.com/w20/jp.png" alt="JPY" />{" "}
                <strong>JPY</strong> <Link to="#">Japanese Yen</Link>
              </li>
              <li>
                <img src="https://flagcdn.com/w20/ph.png" alt="PHP" />{" "}
              ...
              <li>
                <img src="https://flagcdn.com/w20/za.png" alt="ZAR" />{" "}
          ...
          <div className="col">
            <ul className="list-unstyled">
              <li>
                <img src="https://flagcdn.com/w20/au.png" alt="AUD" />{" "}
                <strong>AUD</strong> <Link to="#">Australian Dollar</Link>
              </li>
              <li>
                <img src="https://flagcdn.com/w20/cn.png" alt="CNY" />{" "}
                <strong>CNY</strong> <Link to="#">Chinese Yuan Renminbi</Link>
              </li>
              <li>
                <img src="https://flagcdn.com/w20/hk.png" alt="HKD" />{" "}
                <strong>HKD</strong> <Link to="#">Hong Kong Dollar</Link>
              </li>
              <li>
                <img src="https://flagcdn.com/w20/mx.png" alt="MXN" />{" "}
              ...
              <li>
                <img src="https://flagcdn.com/w20/th.png" alt="THB" />{" "}
          ...
          <div className="col">
            <ul className="list-unstyled">
              <li>
                <img src="https://flagcdn.com/w20/br.png" alt="BRL" />{" "}
              ...
              <li>
                <img src="https://flagcdn.com/w20/my.png" alt="MYR" />{" "}
                <strong>MYR</strong> <Link to="#">Malaysian Ringgit</Link>
              </li>
              <li>
                <img src="https://flagcdn.com/w20/se.png" alt="SEK" />{" "}
