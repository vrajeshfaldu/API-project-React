...
function Home() {
  ...
  <div className="container home-container1 mt-4">
    ...
    <h2 className="converter-title mb-4">1 Euro to US Dollar</h2>
        ...
        <div className="converter-card">
          <div className="row g-3 align-items-center">
            ...
            <div className="col-md-6">
              <div className="input-group">
                <span className="input-group-text">
                  <img src="https://flagcdn.com/w20/eu.png" alt="EU Flag"/>
                </span>
              ...
              <input type="number" defaultValue="1" className="form-control mt-2 exchange-input"/>
            </div>
            ...
            <div className="col-md-6">
              ...
              <input type="text" defaultValue="1.1684" className="form-control mt-2 exchange-input" readOnly/>
            </div>
          </div>
          ...
          <div className="row mt-3">
            <div className="col-md-6">
              <input type="date" style={{height : "50px"}} className="form-control" defaultValue="2025-08-31"/>
            </div>
            <div className="col-md-6 d-flex align-items-center">
              <p className="mb-0 small">Preview interbank rate <strong>+/- 0%</strong></p>
            </div>
          </div>

        
          <div className="mt-3">
            <Link to="#" className="text-decoration-none small fw-bold">Hide Advanced Currency Data</Link>
